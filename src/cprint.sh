...
cprint_gsub() {
    ...
    echo "$@{reset}" | sed \
        ...
        -e 's#{yellowbg}#\\033[43m#g'       -e 's#{Y}#\\033[43m#g'      \
        -e 's#{bluebg}#\\033[44m#g'         -e 's#{B}#\\033[44m#g'      \
        -e 's#{magentabg}#\\033[45m#g'      -e 's#{M}#\\033[45m#g'      \
        -e 's#{cyanbg}#\\033[46m#g'         -e 's#{C}#\\033[46m#g'      \
        -e 's#{whitebg}#\\033[47m#g'        -e 's#{W}#\\033[47m#g'      \
        -e 's#{defbg}#\\033[49m#g'          -e 's#{D}#\\033[49m#g'      \
        -e 's#{\*black\*}#\\033[90m#g'      -e 's#{\*k\*}#\\033[90m#g'  \
        -e 's#{\*red\*}#\\033[91m#g'        -e 's#{\*r\*}#\\033[91m#g'  \
        -e 's#{\*green\*}#\\033[92m#g'      -e 's#{\*g\*}#\\033[92m#g'  \
        -e 's#{\*yellow\*}#\\033[93m#g'     -e 's#{\*y\*}#\\033[93m#g'  \
        -e 's#{\*blue\*}#\\033[94m#g'       -e 's#{\*b\*}#\\033[94m#g'  \
        -e 's#{\*magenta\*}#\\033[95m#g'    -e 's#{\*m\*}#\\033[95m#g'  \
        -e 's#{\*cyan\*}#\\033[96m#g'       -e 's#{\*c\*}#\\033[96m#g'  \
        -e 's#{\*white\*}#\\033[97m#g'      -e 's#{\*w\*}#\\033[97m#g'  \
        -e 's#{\*blackbg\*}#\\033[100m#g'   -e 's#{\*K\*}#\\033[100m#g' \
        -e 's#{\*redbg\*}#\\033[101m#g'     -e 's#{\*R\*}#\\033[101m#g' \
        -e 's#{\*greenbg\*}#\\033[102m#g'   -e 's#{\*G\*}#\\033[102m#g' \
        -e 's#{\*yellowbg\*}#\\033[103m#g'  -e 's#{\*Y\*}#\\033[103m#g' \
        -e 's#{\*bluebg\*}#\\033[104m#g'    -e 's#{\*B\*}#\\033[104m#g' \
        -e 's#{\*magentabg\*}#\\033[105m#g' -e 's#{\*M\*}#\\033[105m#g' \
        -e 's#{\*cyanbg\*}#\\033[106m#g'    -e 's#{\*C\*}#\\033[106m#g' \
        -e 's#{\*whitebg\*}#\\033[107m#g'   -e 's#{\*W\*}#\\033[107m#g'
}
